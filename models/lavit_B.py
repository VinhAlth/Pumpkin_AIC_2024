...
st = time.time()
image_feature = lavit.get_image_features('/dataset/AIC2024/pumkin_dataset/1/frames/pyscenedetect/Keyframes_L11/keyframes/L11_V001/00030.jpg')
print("1st image FE: ", time.time()-st)

st = time.time()
image_feature = lavit.get_image_features('/dataset/AIC2024/pumkin_dataset/1/frames/pyscenedetect/Keyframes_L11/keyframes/L11_V001/00540.jpg')
...
for text in query:
    st = time.time()
    text_feature = lavit.get_text_features(text)
    print("text FE: ", time.time()-st)
    print(text_feature.shape)
    # similarity = cosine(image_feature, text_feature)
    # print(similarity)