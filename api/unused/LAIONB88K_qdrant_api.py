...
FEATURES_PATH= ['/dataset/AIC2024/pumkin_dataset/0/laion_autoshot/', '/dataset/AIC2024/pumkin_dataset/1/laion_autoshot/']
...
RERANK_FEATURES_PATH = ['/dataset/AIC2024/pumkin_dataset/0/mobileclip_autoshot/', '/dataset/AIC2024/pumkin_dataset/1/mobileclip_autoshot/']
RERANK_SIZE = 512
...
qdrant = QDRANT("LAIONB88K")
#qdrant.addDatabase("LAIONB88K", 1024, FEATURES_PATH, SPLIT_NAME)

dummy_query = np.load("/workspace/competitions/AIC_2024/SIU_Pumpkin/libs/vector_database/QDRANT/cat_laion.npy").reshape(1,-1).astype('float32')[0]
