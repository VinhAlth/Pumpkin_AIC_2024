...
FEATURES_PATH= ['/dataset/AIC2024/pumkin_dataset/0/longclip/', '/dataset/AIC2024/pumkin_dataset/1/longclip/']
...
qdrant = QDRANT("LONGCLIP")
qdrant.addDatabase("LONGCLIP", 768, FEATURES_PATH, SPLIT_NAME)

dummy_query = np.load("/workspace/competitions/AIC_2024/SIU_Pumpkin/libs/vector_database/QDRANT/cat_longclip.npy").reshape(1,-1).astype('float32')[0]
