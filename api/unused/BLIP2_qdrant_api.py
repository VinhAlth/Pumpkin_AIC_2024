...
FEATURES_PATH= ['/dataset/AIC2024/pumkin_dataset/0/blip2/']
...
RERANK_FEATURES_PATH = ['/dataset/AIC2024/pumkin_dataset/0/laion/']
RERANK_SIZE = 1024
...
qdrant = QDRANT()
qdrant.addDatabase("BLIP2Coco", 256,FEATURES_PATH, SPLIT_NAME, FILTER_FILE)
...
dummy_query = np.load("/workspace/competitions/AIC_2024/SIU_Pumpkin/libs/vector_database/QDRANT/cat_blip.npy").reshape(1,-1).astype('float32')[0]
