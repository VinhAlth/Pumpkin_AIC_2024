...
FEATURES_PATH= ['/dataset/AIC2024/pumkin_dataset/0/siglip_fix/', '/dataset/AIC2024/pumkin_dataset/1/siglip_fix/', '/dataset/AIC2024/pumkin_dataset/2/siglip/']
...
#qdrant.addDatabase("SIGLIP", 1152, FEATURES_PATH, SPLIT_NAME)

dummy_query = np.load("/workspace/competitions/AIC_2024/SIU_Pumpkin/libs/vector_database/QDRANT/cat_siglip.npy").reshape(1,-1).astype('float32')[0]
